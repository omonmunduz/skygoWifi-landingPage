            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">GLOBAL
COVERAGE</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                130+ Countries & Regions
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">No Contact or Subscription</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                Pay as you go
                </dd>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Unlimited Data
Usage</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
